...
function MaterialList() {
  ...
  useEffect(() => {
    ...
    fetch(`http://127.0.0.1:8000/api/modules/${selectedModule}/materials/`, {
      method: 'GET',
      headers: {
                    ...
                    {material.material_type === 'video' && (
                      <Box sx={{ width: '100%', textAlign: 'center' }}>
                        <video controls style={{ width: '100%', maxWidth: '800px' }}>
                          <source src={`http://127.0.0.1:8000${material.upload}`} type="video/mp4" />
                    ...
                    {material.material_type === 'file' && (
                      <Box sx={{ mt: 2, textAlign: 'center' }}>
                        <Button
                          ...
                          href={`http://127.0.0.1:8000${material.upload}`}
                          download
                        >
                          Download File
                        </Button>
